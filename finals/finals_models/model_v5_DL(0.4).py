...
# from torchvision.models.detection import FocalLoss
    ...
    def fit(self, X, y):
        ...
        for epoch in range(self.num_epochs):
            for batch_idx, batch in enumerate(data_loader):
                ...
                loss = self.criterion(outputs, labels_batch.squeeze())
